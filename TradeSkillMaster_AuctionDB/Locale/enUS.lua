...
L["Scan the auction house for random enchants. Expect this scan to take several minutes or longer."] = true
...
L["Processing random enchant data..."] = true